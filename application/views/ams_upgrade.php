						...
						<div class="rst-content"></div><!-- Aligns the entire content of the header and body at the same margin-->
							<div role="navigation" aria-label="breadcrumbs navigation" style="color:green";>
								<ul class="wy-breadcrumbs">
									...
									<li>Upgrading from previous version of AMS</li>
								</ul>
						<hr/>
							</div>
					<div role="main" class="document">
						<div class="section" id="The Service Level Agreement">
							<h3>Upgrading from previous version of AMS<a class="headerlink" href="#the service level agreement" title="Permalink to this headline"></a></h3>
								<p>1.Go to start on the bottom left corner of my computer</p>
								<p>2.<b>Click</b> on Computer</p>
								<p>3.On the pop up window, open local drive C also known as OS(C:)</p>
								<p>4.<b>Click</b> on AMS folder to open it.</p>
								<p>5.<b>Double click</b> AMS.exe file to upgrade.</p>
								<img class="brand-logo homepage"  src="<?php echo base_url(); ?>public/image/ams_login.jpg"/></a></p>    	
								
						</div><!-- Closes the div class = section -->
	                	<div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
                    		 <a href="/ams_user_guide/ams_user_support" class="btn btn-neutral float-right" title="AMS Issue Log">Next <span class="">
                    		 <a href="/ams_user_guide/installation_instruction" class="btn btn-neutral" title="AMS User Guide"><span class=""></span>Previous</a>
						</div>	 
					</div>	
