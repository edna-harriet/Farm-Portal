...
<html>
	...
	<body class="wy-body-for-nav" role="document" style=""><!-- creates the vertical navbar on the left -->
		...
		<ul>
			...
			<li class= "toctree-12"><a class="reference internal" href="<?php echo site_url('ams_modules')?>">AMS Modules</a></li>
		</ul>
		<ul class="current">	
      			<li class="toctree-11 current"><a class="current reference internal" href="<?php echo site_url('other_modules')?>">AMS Other Modules</a><ul class="current">
      			<li class="toctree-12"><a class="current reference internal" href="">System Overview</a></li>
      			<li class="toctree-12"><a class="reference internal" href="">Interactive Voice Response System(IVRS)</a></li>
      			<li class="toctree-12"><a class="reference internal" href="">Query by Mobile System(QMS)</a></li>
      			<li class="toctree-12"><a class="reference internal" href="">HHTPDA</a></li>
      			<li class="toctree-12"><a class="reference internal" href="">Fleet and Fuel Monitoring System(FFMS)</a></li>
      			<li class="toctree-12"><a class="reference internal" href="">Farmer Web Portal</a></li>
      			<li class="toctree-12"><a class="reference internal" href="">Smart Weighment System(SWS)</a></li>
      		</ul>
		</div>
			</nav>
		</div>
		...
		<h1>Other Modules<a class="headerlink" href="#Instruction Installation" title="Permalink to this headline"></a></h1>
		<p></p>
<footer class="container-fluid footer">
	<div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
		<a href="<?php echo site_url('')?>" class="btn btn-neutral float-right" title=""><span class=""></span>Next</a>
